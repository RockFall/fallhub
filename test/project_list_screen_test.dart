...
import 'package:fallhub/features/projects/presentation/project_list_screen.dart';

void main() {
  testWidgets('ProjectListScreen shows empty state', (tester) async {
    ...
    expect(find.text(AppStrings.projectListEmpty), findsOneWidget);
    await db.close();
    await tester.pumpWidget(const SizedBox.shrink());
  });

  testWidgets('ProjectListScreen lists created project', (tester) async {
    tester.view.physicalSize = const Size(800, 1200);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
