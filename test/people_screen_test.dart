...
void main() {
  testWidgets('PeopleScreen shows empty state and disclaimer', (tester) async {
  ...
  testWidgets('PeopleScreen lists created person', (tester) async {
    tester.view.physicalSize = const Size(800, 1200);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    expect(find.textContaining('Aninha'), findsOneWidget);
