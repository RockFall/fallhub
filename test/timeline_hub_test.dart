...
void main() {
  testWidgets('TravelScreen shows Timeline import how-to on Dia tab',
      (tester) async {
    ...
    await tester.tap(find.text(AppStrings.timelineTabDay));
    await tester.pump();
    await tester.pump(const Duration(milliseconds: 200));
    expect(find.text(AppStrings.timelineEmptyHub), findsOneWidget);
    expect(find.text(AppStrings.timelineImport), findsWidgets);
