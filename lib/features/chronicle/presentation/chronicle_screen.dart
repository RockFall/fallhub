...
class ChronicleScreen extends ConsumerWidget {
  ...
  String _eventTitle(DomainEvent event) {
    return switch (event.eventType) {
      ...
      EventType.musicNodeCreated => 'Nó do Atlas criado',
      EventType.musicNodeUpdated => 'Nó do Atlas actualizado',
      EventType.musicEncounterRecorded => 'Encontro musical registado',
      EventType.musicEncounterCorrected => 'Encontro musical corrigido',
      EventType.musicRelationClaimAdded => 'Relação musical proposta',
      EventType.musicExpeditionDrafted => 'Expedição musical em rascunho',
      EventType.musicExpeditionStarted => 'Expedição musical activa',
      EventType.musicExpeditionCompleted => 'Expedição musical concluída',
      EventType.musicExpeditionAbandoned => 'Expedição musical abandonada',
      EventType.musicAtlasJsonImported => 'Atlas importado de JSON',
      EventType.musicAtlasJsonRolledBack => 'Importação do Atlas revertida',
      EventType.spotifyLibraryPulled => 'Biblioteca Spotify lida',
      EventType.spotifyPlaylistDrafted => 'Playlist virada expedição',
      EventType.spotifyNowPlayingCaptured => 'O que estava a tocar capturado',
      EventType.spotifyLinked => 'Spotify ligado',
      ...
      EventType.activationEpisodeStarted => 'Rota de mobilização iniciada',
      EventType.activationCommandPresented => 'Ordem apresentada',
      EventType.activationProofObserved => 'Prova observada',
      EventType.activationCommandConfirmed => 'Movimento confirmado',
      EventType.activationCommandSkipped => 'Passo pulado',
      EventType.activationRouteAdapted => 'Rota adaptada',
      EventType.frictionShieldApplied => 'Escudo armado',
      EventType.frictionShieldEscaped => 'Escudo liberado',
      EventType.waypointReached => 'Waypoint alcançado',
      EventType.capacityModeChanged => 'Capacidade ajustada',
      EventType.activationEpisodeReleased => 'Pawn liberado',
      EventType.activationEpisodeAborted => 'Rota encerrada',
      EventType.activationEpisodeConvertedToRecovery =>
        'Rota convertida em recuperação',
      EventType.activationFalsePositiveReported => 'Falso positivo corrigido',
      EventType.activationProtocolCompressed => 'Rota comprimida',
      EventType.activationProtocolInternalized => 'Rota internalizada',
      EventType.activationExperimentStarted => 'Experimento iniciado',
      EventType.activationInsightGenerated => 'Padrão associado registrado',
      EventType.activationEpisodePaused => 'Rota pausada',
      EventType.activationEpisodeRestored => 'Rota restaurada',
