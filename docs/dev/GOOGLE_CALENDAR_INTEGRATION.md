...
| Schema / export | Drift **v36**, export **v32** | bump obrigatório se persistirmos tokens/eventos ricos |
...
Novas tabelas (nomes indicativos; schema Drift **v37**, export **v33**):
...
- Tabelas + mappers + export v33 + migration test.
...
9. Novo ADR (este plano) **antes** de código — [ADR-042](../adr/ADR-042-google-calendar.md).
