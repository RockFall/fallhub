...
const exportV22RequiredKeys = <String>{
  'exported_at',
  'version',
  'profile',
  'preferences',
...
void main() {
  test('export v22 toJson exposes golden schema keys', () {
    ...
    expect(json.keys.toSet(), containsAll(exportV22RequiredKeys));
    expect(json['version'], 22);
    expect(json['home_maintenance_tasks'], isA<List>());
  });
}
