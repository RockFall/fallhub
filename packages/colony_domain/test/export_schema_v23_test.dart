...
const exportV23RequiredKeys = <String>{
  'exported_at',
  'version',
  'profile',
  'preferences',
...
void main() {
  test('export v23 toJson exposes golden schema keys', () {
    ...
    expect(json.keys.toSet(), exportV23RequiredKeys);
    expect(json['version'], 23);
    expect(json['quest_inventory_links'], isA<List>());
  });
}
