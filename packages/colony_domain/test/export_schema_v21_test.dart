...
const exportV21RequiredKeys = <String>{
  'exported_at',
  'version',
  'profile',
  'preferences',
...
void main() {
  test('export v21 toJson exposes golden schema keys', () {
    ...
    expect(json.keys.toSet(), containsAll(exportV21RequiredKeys));
    expect(json['version'], 21);
    expect(json['person_organization_links'], isA<List>());
  });
}
