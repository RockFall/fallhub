...
const exportV18RequiredKeys = <String>{
  'exported_at',
  'version',
  'profile',
  'preferences',
...
void main() {
  test('export v18 toJson exposes golden schema keys', () {
    ...
    expect(json.keys.toSet(), containsAll(exportV18RequiredKeys));
    expect(json['version'], 18);
    expect(json['person_interactions'], isA<List>());
  });
}
