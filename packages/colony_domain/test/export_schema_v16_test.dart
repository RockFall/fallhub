...
/// Golden top-level keys for the current write version (export v16).
const exportV16RequiredKeys = <String>{
  'exported_at',
  'version',
  'profile',
  'preferences',
...
void main() {
  test('export v16 toJson exposes golden schema keys', () {
    ...
    expect(json.keys.toSet(), containsAll(exportV16RequiredKeys));
    expect(json['version'], 16);
    expect(json['people'], isA<List>());
    expect(json['inventory_items'], isA<List>());
  });
}
